...
def minimize_marginals(graph, initial_estimate, pose_options):
    # try different pose and landmark options here, and keep the one with the lowest sum of marginals.
    ...
    # Calculate marginal covariances for the relevant variables and visualize the updated factor graph with covariances
